...
let sortedCmd = Object.entries(global.db.data.stats).map(([key, value]) => {
  ...
  sall += i.success
    ...
    let arr = [
      'https://telegra.ph/file/08a3c744d42a8b72240b6.jpg',
      'https://telegra.ph/file/d09bcf10bfe16e4ced631.jpg',
      'https://telegra.ph/file/30eee40a054b4a004d388.jpg',
      'https://telegra.ph/file/08a3c744d42a8b72240b6.jpg'
    ]
   
    conn.send2ButtonLoc(m.chat, pRandom(arr), text, conn.menu?.after || defaultMenu.after || '©レズデブ',  'DEVELOPER', _p+'owner', 'SEWABOT', _p+'sewa')
